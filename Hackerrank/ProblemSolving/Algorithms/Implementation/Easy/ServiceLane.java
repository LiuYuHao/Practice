...
/*
Task: input find the min number on the range of index of each cases
Input: a int[] width, int n the size of width, a 2-d array cases which represents range for each row.
Output: a int array which containes the min width corresponding to the 2d array.
*/
