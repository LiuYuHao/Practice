...
/*
Task: Find the node where the merge begin
*/
public class FindMergePoint {
     ...
     *
     */
     // Better solution, the distance from head1 to head 2 merge point= head 2 to head 1 merge point
     /*
    ...
    static int findMergeNode(SinglyLinkedListNode head1, SinglyLinkedListNode head2) {
      // Brute force solution
        ...
        while(head1_copy != null) {
            while(head2_copy != null) {
                if (head1_copy == head2_copy) {
                    return head1_copy.data;
                }
